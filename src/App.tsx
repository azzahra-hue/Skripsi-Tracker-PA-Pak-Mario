...
import { Plus, Search, FileSpreadsheet, Eye, ArrowUpDown, Sparkles, Globe, UserCheck, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-extrabold text-gray-900 leading-tight">Skripsi Tracker</h1>
                <p className="text-[11px] text-gray-500 font-medium">Monitoring Progress Proposal Skripsi</p>
              </div>
            </div>
            ...
            <nav className="flex items-center bg-gray-100 p-1 rounded-xl">
              ...
              >
                <Globe className="w-4 h-4" /> Tracker Publik
              </button>
              <button
              ...
              >
                <UserCheck className="w-4 h-4" /> Menu Personal {!user && <Lock className="w-3 h-3 text-orange-400" />}
              </button>
            </nav>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {mainTab === 'personal' ? (
          <PersonalWorkspace 
            currentUser={user} 
            onRequireAuth={() => setAuthModal({ isOpen: true, mode: 'login', name: '' })} 
          />
        ) : (
          <>
            {/* Motivational Header */}
